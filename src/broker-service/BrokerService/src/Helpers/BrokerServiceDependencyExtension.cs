...
{
    public static IServiceCollection AddBrokerServiceDependencyGroup(this IServiceCollection services)
    {
        services.AddAccountDependency()
    ...
    private static IServiceCollection AddTradesDependency(this IServiceCollection services)
        => services.AddTransient<ITradeRepository, TradeRepositoryWithDbNotResponding>()
    ...
    private static IServiceCollection AddProblemPatternsDependency(this IServiceCollection services)
        => services.AddScoped<IPluginManager, PluginManager>()
                   .AddScoped<FeatureProvider, PluginProvider>()
                   .AddTransient<IFeatureFlagServiceConnector, FeatureFlagServiceConnector>();
}