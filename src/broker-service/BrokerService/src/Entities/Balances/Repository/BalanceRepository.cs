...
public class BalanceRepository : TransactionalRepository, IBalanceRepository
{
    public BalanceRepository(BrokerDbContext dbContext) : base(dbContext) { }
    ...
    public void UpdateBalance(Balance balance)
        => DbContext.Balances.Update(balance);
}