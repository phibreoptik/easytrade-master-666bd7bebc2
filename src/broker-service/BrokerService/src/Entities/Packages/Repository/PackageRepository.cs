...
public class PackageRepository : TransactionalRepository, IPackageRepository
{
    public PackageRepository(BrokerDbContext dbContext) : base(dbContext) { }
    ...
    public IQueryable<Package?> GetAllPackages()
        => DbContext.Packages.AsQueryable();
}